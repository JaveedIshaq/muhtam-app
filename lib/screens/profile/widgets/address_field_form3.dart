            ...
            children: [
              ...
              ...List.generate(
                ...
                (index) {
                  ...
                  String? conditionalParentValue = get(field, ['custom_attributes', 'data-conditional-parent-value']);
                  ...
                  if (conditionalParent.isNotEmpty) {
                    String defaultNameParent = conditionalParent.split('_').length > 1 ? conditionalParent.split('_').sublist(1).join('_') : conditionalParent;
                    String nameParent = get(field, ['parent', 'name'], defaultNameParent);
                    if (data?[nameParent] != conditionalParentValue) {
                      type = "hidden";
                    }
                  }
