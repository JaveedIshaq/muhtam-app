...
class _ContentDetailState extends State<_ContentDetail> with LoadingMixin, TransitionMixin, SingleTickerProviderStateMixin {
  late AuthStore _authStore;
  late TabController _tabController;

  late List<String> _tabKey;
  String _visitTab = "activity";
  ...
  void didChangeDependencies() {
    ...
    _tabKey = _authStore.isLogin && _authStore.user?.id == widget.store.member?.id?.toString()
        ? ["activity", "profile", "messages", "friends"]
        : ["activity", "profile", "friends"];
